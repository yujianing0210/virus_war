// WebSocket Server:
// Reads input from Arduino and sends commands to the game.
...
const port1 = new SerialPort({ path: '/dev/cu.usbmodem101', baudRate: 9600 }); // Player One
const port2 = new SerialPort({ path: '/dev/cu.usbmodem1101', baudRate: 9600 }); // Player Two
